...
//      ※  JPG, JPEG 리터럴 포맷은 관계없이 정상적으로 변환되는 것 확인.
        ...
        File face2 = new File("./src/main/resources/static/image_similarity_test/face2.jpg");
        InputStream faceStream2 = new FileInputStream(face2);
        List<Mat> faceHist2 = imageHistogram.getHistogram(faceStream2);

        File face3 = new File("./src/main/resources/static/image_similarity_test/face3.jpg");
        InputStream faceStream3 = new FileInputStream(face3);
        List<Mat> faceHist3 = imageHistogram.getHistogram(faceStream3);

//        File face4 = new File("./src/main/resources/static/image_similarity_test/face4.jpg");
        File face4 = new File("./src/main/resources/static/image_similarity_test/face4.jpeg");
